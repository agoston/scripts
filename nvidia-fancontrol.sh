...
nvidia-settings -a '[gpu:0]/GPUFanControlState=1' -a '[fan:0]/GPUTargetFanSpeed=88' -a '[gpu:0]/GPUMemoryTransferRateOffset[3]=900' -a '[gpu:0]/GPUGraphicsClockOffset[3]=0'
